# Film-Suggestion-Recommendation
...
* Acknowledgement points:-
  1. The data fetched is 95% accurate and fetched from the pre available websites such as kaggle.com , movielens.org etc.
  2. There is no plagirism issue as per design and code, i am sole contributor 
